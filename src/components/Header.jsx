...
const Header = () => {
    return (
        <header className='w-full flex justify-center items-center p-6 border-b'>
            <nav className='w-[55%] flex justify-between items-center'>
                <div className='flex justify-between items-center'>
                    <img src={logo} alt="logo" />
                </div>

                <div className='w-2/4 flex justify-around items-center text-xl'>
                    <Link to={"/"} className="hover:cursor-pointer hover:text-purple">Productos</Link>
